...
const PT: Dict = {
  ...
  "hero.chip": "Já disponível pra iOS e Android",
  "hero.subtitle": "um jogo de sintonia mental",
  "hero.description.before": "Dá uma",
  "hero.description.highlight": "dica de uma palavra só",
  "hero.description.after": "sobre um alvo secreto. A galera adivinha junto, no mesmo celular. Quanto mais perto, mais ponto.",
  "hero.tagline": "Aquele jogo que vai salvar suas festas de ficarem no celular.",
  ...
  "how.title": "Três passos. Um celular. Zero ressentimento.",
  ...
  "how.step1.body": "A tela mostra um alvo secreto. Pense numa palavra que represente onde ele está no espectro entre os dois polos.",
  ...
  "features.title.after": "que salva a festa.",
  "features.subtitle": "Aquele jogo que sai do armário toda vez que tem gente nova em casa. O que a tia entende, o sobrinho entende, e ninguém precisa de óculos pra ler.",
...
const EN: Dict = {
  ...
  "hero.description.before": "Give a",
  "hero.description.highlight": "one-word clue",
  "hero.description.after": "about a secret target. The crew guesses together on the same phone. Closer to the target, more points.",
  ...
  "how.title": "Three steps. One phone. Zero awkwardness.",
  ...
  "how.step1.body": "The screen shows a secret target. Think of one word that nails where it falls on the spectrum between the two poles.",
  ...
  "features.title.after": "that saves the party.",
  "features.subtitle": "The one that comes out of the cabinet every time new people show up. Everyone gets it, no glasses needed to read.",
...
const ES: Dict = {
  ...
  "hero.chip": "Ya disponible para iOS y Android",
  "hero.subtitle": "un juego de sintonía mental",
  "hero.description.before": "Dale una",
  "hero.description.highlight": "pista de una palabra",
  "hero.description.after": "sobre un objetivo secreto. La banda adivina junta, en el mismo celular. Mientras más cerca, más puntos.",
  "hero.tagline": "El juego que va a salvar tus fiestas de quedarse en el celular.",
  "hero.stat.spectrums": "espectros",
  ...
  "how.title": "Tres pasos. Un celular. Cero drama.",
  ...
  "how.step1.body": "La pantalla muestra un objetivo secreto. Pensá una palabra que represente dónde cae en el espectro entre los dos polos.",
  ...
  "features.title.after": "que salva la fiesta.",
  "features.subtitle": "Ese juego que sale del armario cada vez que hay gente nueva en casa. Lo entiende la tía, lo entiende el sobrino, y nadie necesita lentes para leerlo.",
