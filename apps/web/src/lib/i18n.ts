...
const PT: Dict = {
  ...
  "hero.tagline": "Funciona com a namorada, com a galera e até com a tia.",
  ...
  "how.subtitle": "Sintonia foi feito pra ser explicado em 20 segundos e jogado sem cerimônia. Sem app pra todo mundo. Sem cadastro. Sem regras decoradas.",
...
const EN: Dict = {
  ...
  "hero.tagline": "Works with your partner, your crew, even your aunt.",
  ...
  "how.subtitle": "Sintonia was built to be explained in 20 seconds and played without ceremony. No app for everyone. No sign-up. No rules to memorize.",
...
const ES: Dict = {
  ...
  "hero.tagline": "Funciona con tu pareja, con la banda, hasta con la tía.",
  "hero.stat.spectrums": "espectros",
  ...
  "how.subtitle": "Sintonía está pensado para explicarse en 20 segundos y jugarse sin vueltas. Sin app para todos. Sin registro. Sin reglas memorizadas.",
